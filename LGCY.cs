...
namespace project
{
    public partial class LGCY : Form
    {
        private LGC fm9;
        ...
        private void SetRan()
        {
            ...
            for (int i = 50; i < 75; i++)
            {
                stockData[i] = random.Next(300001, 600000);
            }
            ...
            {
                stockData[i] = random.Next(500000, 800000);
            }
            for (int i = 125; i < 150; i++)
            {
                stockData[i] = random.Next(300000, 600000);
            }
            for (int i = 150; i < 175; i++)
            {
                stockData[i] = random.Next(300000, 500000);
            }
            ...
            {
                stockData[i] = random.Next(500001, 700001);
            }
            for (int i = 225; i < 250; i++)
            {
                stockData[i] = random.Next(500001, 600000);
            }
            for (int i = 250; i < 275; i++)
            {
                stockData[i] = random.Next(500001, 700000);
            }
            for (int i = 275; i < 300; i++)
            {
                stockData[i] = random.Next(640000, 660000);
            }
        }
